...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_universal(
    // --------+------+-------+--------+--------+--------+                     +----------------+----------------+--------------+----------------+--------+----------
        _______, KC_F1, KC_F2 , KC_F3  , KC_F4  , XXXXXXX,                       XXXXXXX        , KC_BRID        , KC_BRIU      , XXXXXXX        , XXXXXXX, XXXXXXX,
    // --------+------+-------+--------+--------+--------+                     +----------------+----------------+--------------+----------------+--------+----------
        _______, KC_F5, KC_F6 , KC_F7  , KC_F8  , XXXXXXX,                       KC_LEFT        , KC_DOWN        , KC_UP        , KC_RGHT        , KC_BTN3, KC_VOLU,
    // --------+------+-------+--------+--------+--------+                     +----------------+----------------+--------------+----------------+--------+----------
        _______, KC_F9, KC_F10, KC_F11 , KC_F12 , XXXXXXX,                       LCTL_T(KC_LEFT), LCTL_T(KC_DOWN), LCTL_T(KC_UP), LCTL_T(KC_RGHT), XXXXXXX, KC_VOLD,
    // --------+------+-------+--------+--------+--------+---------     -------+----------------+----------------+--------------+----------------+--------+----------
