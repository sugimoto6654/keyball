...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    // ---------------+-----+--------+--------+----------------+--------------+                            +---------------+--------+--------+--------+---------------------+----------
        LT(3, KC_ESC) , KC_Q, KC_W   , KC_E   , KC_R           , KC_T         ,                              KC_Y          , KC_U   , KC_I   , KC_O   , KC_P                , KC_MINS,
    // ---------------+-----+--------+--------+----------------+--------------+                            +---------------+--------+--------+--------+---------------------+----------
        KC_TAB        , KC_A, KC_S   , KC_D   , KC_F           , KC_G         ,                              KC_H          , KC_J   , KC_K   , KC_L   , MT(SCRL_MO, KC_SCLN), KC_QUOT,
    // ---------------+-----+--------+--------+----------------+--------------+                            +---------------+--------+--------+--------+---------------------+----------
        KC_LSFT       , KC_Z, KC_X   , KC_C   , KC_V           , KC_B         ,                              KC_N          , KC_M   , KC_COMM, KC_DOT , KC_SLSH             , KC_BSLS,
    // ---------------+-----+--------+--------+----------------+--------------+----------------     -------+---------------+--------+--------+--------+---------------------+----------
                              KC_LALT, KC_LGUI, LCTL_T(KC_LNG2), LT(1, KC_SPC), LT(3, KC_LNG1),     KC_BSPC, LT(2, KC_ENT) ,          XXXXXXX, XXXXXXX, KC_PSCR
    //                       --------+--------+----------------+--------------+----------------     -------+---------------+        +--------+--------+----------------
  ),
  ...
  [3] = LAYOUT_universal(
    // ---------+--------+---------+---------+--------+--------+                     +----------+--------+--------+--------+---------+-----------
        MO(4)   , CPI_D1K, CPI_D100, CPI_I100, CPI_I1K, XXXXXXX,                       UG_HUEU  , UG_HUED, UG_VALD, UG_VALU, UG_SPDD , UG_SPDU ,
    // ---------+--------+---------+---------+--------+--------+                     +----------+--------+--------+--------+---------+-----------
        KBC_RST , SCRL_TO, SCRL_DVD, SCRL_DVI, XXXXXXX, XXXXXXX,                       UG_NEXT  , RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW, RGB_M_SN,
    // ---------+--------+---------+---------+--------+--------+                     +----------+--------+--------+--------+---------+-----------
        KBC_SAVE, AML_TO , AML_D50 , AML_I50 , XXXXXXX, XXXXXXX,                       UG___PREV, RGB_M_K, RGB_M_X, RGB_M_G, RGB_M_T , RGB_M_TW,
    // ---------+--------+---------+---------+--------+--------+---------     -------+----------+--------+--------+--------+---------+-----------
                            _______, _______ , _______, _______, _______,     _______, _______  ,          XXXXXXX, XXXXXXX, UG_TOGG
    //                   +---------+---------+--------+--------+---------     -------+----------+        +--------+--------+---------
  ),
};
// clang-format on
